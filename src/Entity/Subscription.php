...
class Subscription
{
    private static $planDataNames = ['free', 'pro', 'entreprise'];
    ...
    public function getPlanDataPriceByName(string $name): int
    {
        return self::$planDataPrices[$name];
    }

    public function getPlanDataNames(): array
    {
        return self::$planDataNames;
    }

    public function getPlanDataPrices(): array
    {
